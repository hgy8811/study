...
#### 8.1 更新config
自己打包更新config文件，需要注意生成的apk包的版本号不能太小，不然会导致收费配置是关闭状态，如用72xx的版本号更新的config文件其收费开关都是关闭的[72xx版本无收费功能]，所以注意版本号要保持与当前最新使用的版本号保持相近，避免此类问题。
备注：收费开关打开的版本号是>7580 [即生成的更新config的apk包版本要大于7580]
